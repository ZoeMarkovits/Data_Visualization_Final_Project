function makeLineChart(dataset, xName, yObjs, axisLables) {
    ...
    chartObj.height = 490 - chartObj.margin.top - chartObj.margin.bottom;
...
// Get the max of every yFunct
    ...
    chartObj.yScale = d3.scale.linear().range([chartObj.height, 0]).domain([-5, 90]);
...
// Render the chart
    chartObj.render = function () {
        ...
        function mousemove() {
            ...
            focus.select(".focus.year").text("Day: " + chartObj.xFormatter(chartObj.xFunct(d)));
        }
